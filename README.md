...
저와 같이 레트로 게임 프로그래밍 개발 문화 확산에 동참해서
다양한 레트로 게임을 개발할 수 있기를 바래봅니다.

[디스코드](https://discord.gg/WDJ8NS6ys3)  
...
독자분의 좋은 피드백을 많이 주시면 참조페이지의 내용은 보다 더 강화될 것이며
...
궁극적으로는 일관된 인터페이스를 통해 레트로 게임을 여러 플랫폼에 배포하기 위한 추상화 인터페이스에
대한 연구를 진행하고 있다고 이해하시면 되겠습니다. 

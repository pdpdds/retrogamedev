...
## 18.3 알레그로4 프로그래밍 기초
* [알레그로 프로그래밍 가이드](https://liballeg.org/docs.html)  
...
### Tiled 맵 레퍼런스
* [TMX 파서](https://github.com/sainteos/tmxparser)
* [TMX C 로더](https://github.com/baylej/tmx)
...
## 18.9 폭스레인저 리메이크
* [폭스레인저 리메이크 툴](https://github.com/pdpdds/allegro4_dos/releases)


## 레퍼런스
### DJGPP
* [DJGPP ALLEGRO](http://www.delorie.com/pub/djgpp/current/v2tk/allegro)  
* [DJGPP 써드파티](http://www.delorie.com/pub/djgpp/current/v2tk)  
* [DJGPP FAQ](https://www.hzdr.de/FWR/VB/TUTORIALS/djgppfaq.html)

### 알레그로4 관련 서적
* [Game Programming All in One](https://github.com/hughbien/notebook/blob/master/game_programming_all_in_one.md)  
